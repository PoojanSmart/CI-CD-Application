 ...
 public class LoginBean {
   ...
   GenericType<UserMaster> guser;
    ...
    public void setRedirectionURL(String redirectionURL) {
        if(redirectionURL.equals("/") || redirectionURL.equals("") )
            this.redirectionURL = "/common/home.jsf";
        else
   ...
   public String login()
    {
       ...
       //} 
          ...
          //res=client.loginUser(Response.class,username,new UserPasswordHash().generate(password.toCharArray()));
           UserMaster loginUser=fbl.loginUser(username,new UserPasswordHash().generate(password.toCharArray()));
        ...
        Map<String,String> x = FacesContext.getCurrentInstance().getExternalContext().getRequestParameterMap();

        String url = origRequest.getQueryString();
      return this.redirectionURL+"?faces-redirect=true";
    }
